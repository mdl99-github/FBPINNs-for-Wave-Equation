...
# Script para generar soluciones de jwave para una imagen determinada como presión inicial.

im = Image.open('imagenes/tejido_pequeno0.png') 

im = -(np.array(im.convert('L'))[:,8:-14]/255 - 1)

print("before", im.shape)

im = ndimage.zoom(im, (490/494, 490/494), order=1).T
